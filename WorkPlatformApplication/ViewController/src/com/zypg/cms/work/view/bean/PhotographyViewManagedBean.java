...
public class PhotographyViewManagedBean extends CustomManagedBean {
    public PhotographyViewManagedBean() {
    }
    ...
    public void initInfo4View() {
        ...
        try {
            ...
            CommonUtil.getPhotographyFigureAM().initInfo4View(docId);
            //根据docId判断是否有exif信息
