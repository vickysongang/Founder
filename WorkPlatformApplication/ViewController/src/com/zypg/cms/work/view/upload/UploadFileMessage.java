    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException,
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                json =
"<script type='text/javascript' id='" + jsonp + "'>parent." + jsonp + "({name:'" + fileItem.getName().substring(fileItem.getName().lastIndexOf("\\") +
                                                                                                                1) +
 "',size:'" + size + "',type:'" + fileItem.getContentType() + "'});setTimeout(function(){delete parent." + jsonp +
 ";var s=document.getElementById('" + jsonp + "');s.parentNode.removeChild(s);},50);</script>";
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
