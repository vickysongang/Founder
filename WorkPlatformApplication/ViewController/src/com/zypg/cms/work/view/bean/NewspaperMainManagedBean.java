...
import com.zypg.cms.work.model.viewobject.newspaper.query.CmsNewspaperQVORowImpl;
import com.zypg.cms.work.model.viewobject.newspaper.query.CmsNewspaperVORowImpl;
...
public class NewspaperMainManagedBean extends CustomManagedBean {
    private List<List<Map<String, Object>>> docList = new ArrayList<List<Map<String, Object>>>();
    CustomTableModel<CmsNewspaperVORowImpl> tableModel =
        new CustomTableModel<CmsNewspaperVORowImpl>("WorkAMDataControl", "NewspaperAM", "CmsNewspaperVO", 20,
                                                    "findNewspaperVC");
    ...
    public NewspaperMainManagedBean() {
    }
    ...
    public void generateList() {
        int i = 5;
        List<CmsNewspaperVORowImpl> model = tableModel.getModel();
        List<List<Map<String, Object>>> list = new ArrayList<List<Map<String, Object>>>();
        List<Map<String, Object>> l = new ArrayList<Map<String, Object>>();
        for (Row row : model) {
            Map<String, Object> map = new HashMap<String, Object>();
            map.put("newspaperId", row.getAttribute("NewspaperId"));
            ...
            String newspaperCategoryName = (String)row.getAttribute("NewspaperCategoryName");
            if (newspaperCategoryName != null) {
                newspaperCategoryName = newspaperCategoryName + editor;
                map.put("newspaperCategoryName",
                        newspaperCategoryName.length() > 10 ? newspaperCategoryName.substring(0, 10) + "..." :
                        newspaperCategoryName);
            } else {
                newspaperCategoryName = "";
                map.put("newspaperCategoryName", newspaperCategoryName + editor);
            }
            map.put("newsNum", row.getAttribute("NewsNum"));
    ...
    public void imageDblClick(ClientEvent clientEvent) {
        ...
        String url = request.getContextPath() + "/faces/work/newspaper/inline/relatedNewspaperView.jsf?docId=" + docId;
        this.openWindow(url);
    }

    public void newspaperTableDblClick(ClientEvent clientEvent) {
        Map<String, Object> map = clientEvent.getComponent().getAttributes();
    ...
    public void complexRearchReturnListener(ReturnEvent returnEvent) {
        ...
        if ("Y".equals(comfirmFlag)) {
            CmsNewspaperQVORowImpl queryRow =
                (CmsNewspaperQVORowImpl)CommonUtil.getNewspaperAM().getCmsNewspaperQVO().getCurrentRow();
            Map<String, Object> additionalParamMap = new HashMap<String, Object>();
            for (AttributeDef def : CommonUtil.getNewspaperAM().getCmsNewspaperQVO().getAttributeDefs()) {
    ...
    public void setTableModel(CustomTableModel<CmsNewspaperVORowImpl> tableModel) {
        this.tableModel = tableModel;
    }

    public CustomTableModel<CmsNewspaperVORowImpl> getTableModel() {
        return tableModel;
    }
