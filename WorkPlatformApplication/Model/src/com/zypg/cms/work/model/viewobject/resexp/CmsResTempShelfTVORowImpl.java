...
import com.zypg.cms.work.model.entity.CmsResTempShelfTEOImpl;
...
// ---------------------------------------------------------------------
public class CmsResTempShelfTVORowImpl extends ViewRowImpl {


    public static final int ENTITY_CMSRESTEMPSHELFTEO = 0;
    ...
    public enum AttributesEnum {
        ApplySubmitFlag {
            public Object get(CmsResTempShelfTVORowImpl obj) {
                return obj.getApplySubmitFlag();
            }

            public void put(CmsResTempShelfTVORowImpl obj, Object value) {
        ...
        DeleteFlagDisplay {
            public Object get(CmsResTempShelfTVORowImpl obj) {
                return obj.getDeleteFlagDisplay();
            }

            public void put(CmsResTempShelfTVORowImpl obj, Object value) {
                obj.setDeleteFlagDisplay((String)value);
            }
        }
        ,
        ApplySubmitFlagDisplay {
            public Object get(CmsResTempShelfTVORowImpl obj) {
                return obj.getApplySubmitFlagDisplay();
            }

            public void put(CmsResTempShelfTVORowImpl obj, Object value) {
                obj.setApplySubmitFlagDisplay((String)value);
            }
        }
        ;
        ...
        public abstract Object get(CmsResTempShelfTVORowImpl object);

        public abstract void put(CmsResTempShelfTVORowImpl object, Object value);
    ...
    public static final int DELETEFLAGDISPLAY = AttributesEnum.DeleteFlagDisplay.index();
    public static final int APPLYSUBMITFLAGDISPLAY = AttributesEnum.ApplySubmitFlagDisplay.index();

    /**
     * This is the default constructor (do not remove).
     */
    public CmsResTempShelfTVORowImpl() {
    }

    /**
     * Gets CmsResTempShelfTEO entity object.
     * @return the CmsResTempShelfTEO
     */
    public CmsResTempShelfTEOImpl getCmsResTempShelfTEO() {
        return (CmsResTempShelfTEOImpl)getEntity(ENTITY_CMSRESTEMPSHELFTEO);
    }

    /**
     * Gets the attribute value for APPLY_SUBMIT_FLAG using the alias name ApplySubmitFlag.
     * @return the APPLY_SUBMIT_FLAG
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for APPLY_SUBMIT_FLAG using the alias name ApplySubmitFlag.
     * @param value value to set the APPLY_SUBMIT_FLAG
     */
    ...
    /**
     * Gets the attribute value for SHELF_ID using the alias name ShelfId.
     * @return the SHELF_ID
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for SHELF_ID using the alias name ShelfId.
     * @param value value to set the SHELF_ID
     */
    ...
    /**
     * Gets the attribute value for the calculated attribute DeleteFlagDisplay.
     * @return the DeleteFlagDisplay
     */
    public String getDeleteFlagDisplay() {
        return (String) getAttributeInternal(DELETEFLAGDISPLAY);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute DeleteFlagDisplay.
     * @param value value to set the  DeleteFlagDisplay
     */
    public void setDeleteFlagDisplay(String value) {
        setAttributeInternal(DELETEFLAGDISPLAY, value);
    }

    /**
     * Gets the attribute value for the calculated attribute ApplySubmitFlagDisplay.
     * @return the ApplySubmitFlagDisplay
     */
    public String getApplySubmitFlagDisplay() {
        return (String) getAttributeInternal(APPLYSUBMITFLAGDISPLAY);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute ApplySubmitFlagDisplay.
     * @param value value to set the  ApplySubmitFlagDisplay
     */
    public void setApplySubmitFlagDisplay(String value) {
        setAttributeInternal(APPLYSUBMITFLAGDISPLAY, value);
    }
