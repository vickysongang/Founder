...
import com.zypg.cms.work.model.entity.CmsRollbackLogTEOImpl;
...
// ---------------------------------------------------------------------
public class CmsRollbackLogTVORowImpl extends ViewRowImpl {


    public static final int ENTITY_CMSROLLBACKLOGTEO = 0;
    ...
    public enum AttributesEnum {
        LogId {
            public Object get(CmsRollbackLogTVORowImpl obj) {
                return obj.getLogId();
            }

            public void put(CmsRollbackLogTVORowImpl obj, Object value) {
        ...
        public abstract Object get(CmsRollbackLogTVORowImpl object);

        public abstract void put(CmsRollbackLogTVORowImpl object, Object value);
     ...
     */
    public CmsRollbackLogTVORowImpl() {
    }

    /**
     * Gets CmsRollbackLogTEO entity object.
     * @return the CmsRollbackLogTEO
     */
    public CmsRollbackLogTEOImpl getCmsRollbackLogTEO() {
        return (CmsRollbackLogTEOImpl)getEntity(ENTITY_CMSROLLBACKLOGTEO);
    }
    ...
    /**
     * Gets the attribute value for ROLLBACK_OPERATOR using the alias name RollbackOperator.
     * @return the ROLLBACK_OPERATOR
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for ROLLBACK_OPERATOR using the alias name RollbackOperator.
     * @param value value to set the ROLLBACK_OPERATOR
     */
    ...
    /**
     * Gets the attribute value for ROLLBACK_REASON using the alias name RollbackReason.
     * @return the ROLLBACK_REASON
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for ROLLBACK_REASON using the alias name RollbackReason.
     * @param value value to set the ROLLBACK_REASON
     */
