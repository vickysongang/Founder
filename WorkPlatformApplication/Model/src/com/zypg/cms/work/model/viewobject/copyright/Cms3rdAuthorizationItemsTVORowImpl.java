...
import com.zypg.cms.work.model.entity.Cms3rdAuthorizationItemsTEOImpl;
...
// ---------------------------------------------------------------------
public class Cms3rdAuthorizationItemsTVORowImpl extends ViewRowImpl {


    public static final int ENTITY_CMS3RDAUTHORIZATIONITEMSTEO = 0;
    ...
    public enum AttributesEnum {
        ItemId {
            public Object get(Cms3rdAuthorizationItemsTVORowImpl obj) {
                return obj.getItemId();
            }

            public void put(Cms3rdAuthorizationItemsTVORowImpl obj, Object value) {
        ...
        ItemsId {
            public Object get(Cms3rdAuthorizationItemsTVORowImpl obj) {
                return obj.getItemsId();
            }

            public void put(Cms3rdAuthorizationItemsTVORowImpl obj, Object value) {
                obj.setItemsId((Number)value);
            }
        }
        ,
        SalesCost {
        ...
        public abstract Object get(Cms3rdAuthorizationItemsTVORowImpl object);

        public abstract void put(Cms3rdAuthorizationItemsTVORowImpl object, Object value);
    ...
    public static final int ITEMSID = AttributesEnum.ItemsId.index();
     ...
     */
    public Cms3rdAuthorizationItemsTVORowImpl() {
    }

    /**
     * Gets Cms3rdAuthorizationItemsTEO entity object.
     * @return the Cms3rdAuthorizationItemsTEO
     */
    public Cms3rdAuthorizationItemsTEOImpl getCms3rdAuthorizationItemsTEO() {
        return (Cms3rdAuthorizationItemsTEOImpl)getEntity(ENTITY_CMS3RDAUTHORIZATIONITEMSTEO);
    }
    ...
    /**
     * Gets the attribute value for ITEMS_ID using the alias name ItemsId.
     * @return the ITEMS_ID
     */
    public Number getItemsId() {
        return (Number) getAttributeInternal(ITEMSID);
    }

    /**
     * Sets <code>value</code> as attribute value for ITEMS_ID using the alias name ItemsId.
     * @param value value to set the ITEMS_ID
     */
    public void setItemsId(Number value) {
        setAttributeInternal(ITEMSID, value);
    }

    /**
     * Gets the attribute value for SALES_COST using the alias name SalesCost.
     * @return the SALES_COST
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for SALES_COST using the alias name SalesCost.
     * @param value value to set the SALES_COST
     */
    ...
    /**
     * Gets the attribute value for SALES_NUM using the alias name SalesNum.
    ...
    /**
     * Sets <code>value</code> as attribute value for SALES_NUM using the alias name SalesNum.
     * @param value value to set the SALES_NUM
     */
