...
// ---    Mon May 05 14:16:27 CST 2014
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class CmsPeriodicalTEOImpl extends CustomEntityImpl {
    public void lock() {
        try {
            super.lock();
    ...
    public enum AttributesEnum {
        PeriodicalId {
            public Object get(CmsPeriodicalTEOImpl obj) {
                return obj.getPeriodicalId();
            }

            public void put(CmsPeriodicalTEOImpl obj, Object value) {
        ...
        public abstract Object get(CmsPeriodicalTEOImpl object);

        public abstract void put(CmsPeriodicalTEOImpl object, Object value);
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("com.zypg.cms.work.model.entity.CmsPeriodicalTEO");
    }

    /**
     * Gets the attribute value for PeriodicalId, using the alias name PeriodicalId.
     * @return the value of PeriodicalId
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for PeriodicalId.
    ...
    /**
     * @param periodicalId key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(Number periodicalId) {
        return new Key(new Object[]{periodicalId});
    }
    ...
    protected void create(AttributeList attributeList) {
        ...
        SequenceImpl si = new SequenceImpl("CMS_PERIODICAL_S", this.getDBTransaction());
        this.setPeriodicalId(si.getSequenceNumber());
    }
