...
import com.zypg.cms.work.model.entity.CmsThemeTEOImpl;
...
// ---------------------------------------------------------------------
public class CmsThemeTVORowImpl extends ViewRowImpl {


    public static final int ENTITY_CMSTHEMETEO = 0;
    ...
    public enum AttributesEnum {
        ThemeId {
            public Object get(CmsThemeTVORowImpl obj) {
                return obj.getThemeId();
            }

            public void put(CmsThemeTVORowImpl obj, Object value) {
        ...
        public abstract Object get(CmsThemeTVORowImpl object);

        public abstract void put(CmsThemeTVORowImpl object, Object value);
     ...
     */
    public CmsThemeTVORowImpl() {
    }

    /**
     * Gets CmsThemeTEO entity object.
     * @return the CmsThemeTEO
     */
    public CmsThemeTEOImpl getCmsThemeTEO() {
        return (CmsThemeTEOImpl)getEntity(ENTITY_CMSTHEMETEO);
    }

    /**
     * Gets the attribute value for THEME_ID using the alias name ThemeId.
     * @return the THEME_ID
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for THEME_ID using the alias name ThemeId.
     * @param value value to set the THEME_ID
     */
    ...
    /**
     * Gets the attribute value for THEME_NAME using the alias name ThemeName.
    ...
    /**
     * Sets <code>value</code> as attribute value for THEME_NAME using the alias name ThemeName.
     * @param value value to set the THEME_NAME
     */
    ...
    /**
     * Gets the attribute value for THEME_DESC using the alias name ThemeDesc.
     * @return the THEME_DESC
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for THEME_DESC using the alias name ThemeDesc.
     * @param value value to set the THEME_DESC
     */
    ...
    /**
     * Gets the attribute value for BINDING_THEME_ID using the alias name BindingThemeId.
     * @return the BINDING_THEME_ID
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for BINDING_THEME_ID using the alias name BindingThemeId.
     * @param value value to set the BINDING_THEME_ID
     */
    ...
    /**
     * Gets the attribute value for BINDING_THEME_NAME using the alias name BindingThemeName.
     * @return the BINDING_THEME_NAME
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for BINDING_THEME_NAME using the alias name BindingThemeName.
     * @param value value to set the BINDING_THEME_NAME
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute UserDisplayName.
