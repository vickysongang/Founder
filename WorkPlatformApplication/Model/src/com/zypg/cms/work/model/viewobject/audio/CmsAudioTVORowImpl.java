...
import com.zypg.cms.work.model.entity.CmsAudioTEOImpl;
...
// ---------------------------------------------------------------------
public class CmsAudioTVORowImpl extends ViewRowImpl {


    public static final int ENTITY_CMSAUDIOTEO = 0;
    ...
    public enum AttributesEnum {
        AssortBook {
            public Object get(CmsAudioTVORowImpl obj) {
                return obj.getAssortBook();
            }

            public void put(CmsAudioTVORowImpl obj, Object value) {
        ...
        AudioType {
            public Object get(CmsAudioTVORowImpl obj) {
                return obj.getAudioType();
            }

            public void put(CmsAudioTVORowImpl obj, Object value) {
                obj.setAudioType((String)value);
            }
        }
        ,
        CarrierType {
        ...
        public abstract Object get(CmsAudioTVORowImpl object);

        public abstract void put(CmsAudioTVORowImpl object, Object value);
    ...
    public static final int AUDIOTYPE = AttributesEnum.AudioType.index();
     ...
     */
    public CmsAudioTVORowImpl() {
    }

    /**
     * Gets CmsAudioTEO entity object.
     * @return the CmsAudioTEO
     */
    public CmsAudioTEOImpl getCmsAudioTEO() {
        return (CmsAudioTEOImpl)getEntity(ENTITY_CMSAUDIOTEO);
    }
    ...
    /**
     * Gets the attribute value for AUDIO_ID using the alias name AudioId.
     * @return the AUDIO_ID
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for AUDIO_ID using the alias name AudioId.
     * @param value value to set the AUDIO_ID
     */
    ...
    /**
     * Gets the attribute value for AUDIO_TYPE using the alias name AudioType.
     * @return the AUDIO_TYPE
     */
    public String getAudioType() {
        return (String) getAttributeInternal(AUDIOTYPE);
    }

    /**
     * Sets <code>value</code> as attribute value for AUDIO_TYPE using the alias name AudioType.
     * @param value value to set the AUDIO_TYPE
     */
    public void setAudioType(String value) {
        setAttributeInternal(AUDIOTYPE, value);
    }
    ...
    /**
     * Gets the attribute value for RECORD_USER using the alias name RecordUser.
     * @return the RECORD_USER
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for RECORD_USER using the alias name RecordUser.
     * @param value value to set the RECORD_USER
     */
    ...
    /**
     * Gets the attribute value for the calculated attribute Script.
     * @return the Script
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute Script.
