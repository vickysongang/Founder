...
import com.zypg.cms.work.model.entity.CmsThemeResourceTEOImpl;
...
// ---------------------------------------------------------------------
public class CmsThemeResourceTVORowImpl extends ViewRowImpl {
    public static final int ENTITY_CMSTHEMERESOURCETEO = 0;
    ...
    public enum AttributesEnum {
        ResourceId {
            public Object get(CmsThemeResourceTVORowImpl obj) {
                return obj.getResourceId();
            }

            public void put(CmsThemeResourceTVORowImpl obj, Object value) {
        ...
        public abstract Object get(CmsThemeResourceTVORowImpl object);

        public abstract void put(CmsThemeResourceTVORowImpl object, Object value);
     ...
     */
    public CmsThemeResourceTVORowImpl() {
    }

    /**
     * Gets CmsThemeResourceTEO entity object.
     * @return the CmsThemeResourceTEO
     */
    public CmsThemeResourceTEOImpl getCmsThemeResourceTEO() {
        return (CmsThemeResourceTEOImpl)getEntity(ENTITY_CMSTHEMERESOURCETEO);
    }
    ...
    /**
     * Sets <code>value</code> as attribute value for TREE_NODE_ID using the alias name TreeNodeId.
     * @param value value to set the TREE_NODE_ID
     */
