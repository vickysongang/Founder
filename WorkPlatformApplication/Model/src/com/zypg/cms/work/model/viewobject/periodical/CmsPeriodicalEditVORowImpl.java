...
public class CmsPeriodicalEditVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        public int index() {
            return CmsPeriodicalEditVORowImpl.AttributesEnum.firstIndex() + ordinal();
        }
        ...
        public static int count() {
            return CmsPeriodicalEditVORowImpl.AttributesEnum.firstIndex() + CmsPeriodicalEditVORowImpl.AttributesEnum.staticValues().length;
        }

        public static AttributesEnum[] staticValues() {
            if (vals == null) {
                vals = CmsPeriodicalEditVORowImpl.AttributesEnum.values();
            }
            return vals;
        }
    }
