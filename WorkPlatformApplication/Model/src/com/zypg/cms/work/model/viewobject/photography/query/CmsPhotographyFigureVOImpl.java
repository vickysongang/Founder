...
// ---------------------------------------------------------------------
public class CmsPhotographyFigureVOImpl extends ViewObjectImpl {
    /**
     * This is the default constructor (do not remove).
     */
    public CmsPhotographyFigureVOImpl() {
    }
    ...
    /**
     * Returns the variable value for bvGroupDetailFlag.
     * @return variable value for bvGroupDetailFlag
     */
    public String getbvGroupDetailFlag() {
        return (String)ensureVariableManager().getVariableValue("bvGroupDetailFlag");
    }

    /**
     * Sets <code>value</code> for variable bvGroupDetailFlag.
     * @param value value to bind as bvGroupDetailFlag
     */
    public void setbvGroupDetailFlag(String value) {
        ensureVariableManager().setVariableValue("bvGroupDetailFlag", value);
    }
