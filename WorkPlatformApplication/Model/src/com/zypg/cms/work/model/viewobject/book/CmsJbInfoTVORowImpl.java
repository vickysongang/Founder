...
import com.zypg.cms.work.model.entity.CmsJbInfoTEOImpl;
...
// ---    Tue May 06 12:36:16 CST 2014
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class CmsJbInfoTVORowImpl extends ViewRowImpl {


    public static final int ENTITY_CMSJBINFOTEO = 0;
    ...
    public enum AttributesEnum {
        JbInfoId {
            public Object get(CmsJbInfoTVORowImpl obj) {
                return obj.getJbInfoId();
            }

            public void put(CmsJbInfoTVORowImpl obj, Object value) {
        ...
        public abstract Object get(CmsJbInfoTVORowImpl object);

        public abstract void put(CmsJbInfoTVORowImpl object, Object value);
     ...
     */
    public CmsJbInfoTVORowImpl() {
    }

    /**
     * Gets CmsJbInfoTEO entity object.
     * @return the CmsJbInfoTEO
     */
    public CmsJbInfoTEOImpl getCmsJbInfoTEO() {
        return (CmsJbInfoTEOImpl)getEntity(ENTITY_CMSJBINFOTEO);
    }

    /**
     * Gets the attribute value for JB_INFO_ID using the alias name JbInfoId.
     * @return the JB_INFO_ID
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for JB_INFO_ID using the alias name JbInfoId.
     * @param value value to set the JB_INFO_ID
     */
    ...
    /**
     * Gets the attribute value for BRIEF_INTRODUCTION using the alias name BriefIntroduction.
    ...
    /**
     * Sets <code>value</code> as attribute value for BRIEF_INTRODUCTION using the alias name BriefIntroduction.
     * @param value value to set the BRIEF_INTRODUCTION
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for CATALOG using the alias name Catalog.
    ...
    /**
     * Sets <code>value</code> as attribute value for FOREWORD using the alias name Foreword.
    ...
    /**
     * Sets <code>value</code> as attribute value for POSTSCRIPT using the alias name Postscript.
    ...
    /**
     * Sets <code>value</code> as attribute value for PREFACE using the alias name Preface.
    ...
    /**
     * Sets <code>value</code> as attribute value for GLOSSARY using the alias name Glossary.
    ...
    /**
     * Gets the attribute value for REFERENCES using the alias name References1.
    ...
    /**
     * Sets <code>value</code> as attribute value for REFERENCES using the alias name References1.
    ...
    /**
     * Gets the attribute value for AUTHOR_INTRODUCTION using the alias name AuthorIntroduction.
     * @return the AUTHOR_INTRODUCTION
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for AUTHOR_INTRODUCTION using the alias name AuthorIntroduction.
     * @param value value to set the AUTHOR_INTRODUCTION
     */
